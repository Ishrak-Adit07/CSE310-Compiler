...
public:
    ...
    bool setAtScopeTable(int position, SymbolInfo* &newNode, ofstream &outstream){
    ...
    SymbolInfo* lookUpElementAtScopeTable(int position, string name, ofstream &outstream){
    ...
    bool deleteFromScopeTable(int position, string name, ofstream &outstream){
    ...
    bool Insert(string name, string type, ofstream &outstream){
        ...
        if(this->setAtScopeTable(hashValue, newSymbolInfo, outstream)) return true;
    ...
    bool Lookup(string name,ofstream &outstream){
        ...
        int hashValue = sdbmHashFunction(name);
        if(this->lookUpElementAtScopeTable(hashValue, name, outstream)) return true;
    ...
    bool Delete(string name,ofstream &outstream){
        ...
        int hashValue = sdbmHashFunction(name);
        if(this->deleteFromScopeTable(hashValue, name, outstream)) return true;
